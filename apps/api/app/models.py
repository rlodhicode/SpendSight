...
class User(Base):
    ...
    bills: Mapped[list["BillRecord"]] = relationship(back_populates="user")
...
class Document(Base):
    ...
    job: Mapped["ProcessingJob"] = relationship(back_populates="document", uselist=False)
    bill: Mapped["BillRecord"] = relationship(back_populates="document", uselist=False)
